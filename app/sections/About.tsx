    ...
    <section id="about" className="py-24 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <FadeIn>
          ...
          <div className="w-12 h-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded mb-12" />
        </FadeIn>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <FadeIn delay={100}>
            ...
            <a href="/resume.pdf"
              className="inline-flex items-center gap-2 mt-8 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold text-sm hover:from-blue-500 hover:to-indigo-500 transition-all shadow-md shadow-blue-200">
              Download Resume ↓
            </a>
          </FadeIn>
          ...
          <FadeIn delay={200}>
            ...
            <div className="flex flex-col gap-6">
              {education.map((edu, i) => (
                <div key={edu.degree}
                  className="relative pl-5 border-l-2 border-transparent"
                  style={{ borderImage: "linear-gradient(to bottom, #2563eb, #6366f1) 1" }}>
                  <p className="font-semibold text-slate-800">{edu.degree}</p>
                  <p className="text-slate-500 text-sm mt-0.5">{edu.school}</p>
                  <p className="text-blue-600 text-sm font-medium mt-0.5">{edu.period}</p>
